...
<script setup lang="ts">
  ...
  const { items, loading, isOnLoadMore, getItems } = useInfiniteScroll<BaseResponse<Movie>, Movie>('https://api.themoviedb.org/3/movie/popular?api_key=803a77b2748b6f5d6363b4fa92bfd870&language=en-US');
